...
SHELL_STATIC_SUBCMD_SET_CREATE(
	...
	SHELL_CMD_ARG(start, NULL,
		      "Arm a 1 Hz PPS waveform once; no autonomous monitoring or rearming.\n"
		      "Usage: start <name> <channel> [pulse_width_ns]",
		      cmd_pps_start, 3, 1),
