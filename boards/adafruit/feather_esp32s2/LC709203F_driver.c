 ...
 */
static int lc709203f_sample_fetch(const struct device *dev,
 ...
 */
static int lc709203f_channel_get(const struct device *dev,
				 enum sensor_channel chan,
...
static int lc709203f_init(const struct device *dev)
{
	...
	LOG_INF("LC709203F initialized on I2C bus %s (addr 0x%x)",
		cfg->i2c->name, cfg->i2c_addr);
...
static const struct sensor_driver_api lc709203f_driver_api = {
	.sample_fetch = lc709203f_sample_fetch,
	.channel_get  = lc709203f_channel_get,
...
#define LC709203F_INIT(inst)                                                  \
	...
	static const struct lc709203f_config lc709203f_config_##inst = {        \
		...
		.i2c_addr = DT_INST_REG_ADDR(inst),                            \
	                                                                        ...
	                                                                        \
	DEVICE_DT_INST_DEFINE(inst, lc709203f_init, NULL,                       \
			      &lc709203f_data_##inst, &lc709203f_config_##inst,   \
