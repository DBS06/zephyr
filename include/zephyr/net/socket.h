...
/** Enable PTP ownership ancillary data on packet sockets (integer boolean). */
#define ZSOCK_SO_PTP_OFFLOAD  62
/** PTP packet instructions/status; payload is struct net_ptp_packet. */
#define ZSOCK_SCM_PTP_OFFLOAD ZSOCK_SO_PTP_OFFLOAD
