 ...
 * ASCII letters, digits, '.', '-', and '_'. The clock remains owned by the
 * caller and must remain valid until @ref precision_timing_shell_unregister
 * returns.
 *
 ...
 * waits for in-flight shell operations to complete. After this function
 * returns, the caller may release the clock object.
 *
